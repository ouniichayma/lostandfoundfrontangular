...
@Component({
  selector: 'app-add-lost-object',
  standalone: false,
  templateUrl: './add-lost-object.component.html',
  styleUrl: './add-lost-object.component.css'
})
export class AddLostObjectComponent implements OnInit {
  ...
  lostObject: LostAndFoundObject = {
    ...
    id: 0,
    isClaimed: false,
    status: 'Lost', // Définir directement ici
 ...
 ngOnInit(): void {
  ...
  onSubmit() {
    ...
    this.http.post('https://localhost:7243/api/object/declare/lost', formData)
      .subscribe({
